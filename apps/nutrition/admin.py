...
class DietaryLogAdmin(ExportCsvMixin, admin.ModelAdmin):
    ...
    # CSV 导出配置
    export_fields = [
        'id', 'user', 'food_name', 'calories', 'protein',
        'fat', 'carbohydrate', 'fiber', 'meal_type', 'date'
    ]
    export_filename = 'dietary_logs'

    # 列表页显示字段
    list_display = [
        'id', 'user', 'get_food_name', 'calories', 'meal_type', 'date', 'created_at'
    ]
